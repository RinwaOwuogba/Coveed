...
class PatientHome extends Component {
  ...
  getCurrentTemperature = () => {
    ...
    const latestTemp = this.props.symptoms[symptomsRecordsLength - 1].specifics
      .fever_degree;
    return latestTemp;
  };
          ...
          <div className="patient-home-container">
            <div className="patient-home-profile">
              ...
              <div className="patient-home-image__wrapper">
                <span onClick={this.logUserOut} className="logout-span">
                  Logout
                </span>
                <img
            ...
            <section className="patient-home-records-container">
              ...
              <div className="patient-home-records">
                <div className="patient-home-body-temp">
                  ...
                  <span className="temp">
                    {`${this.getCurrentTemperature() || "____"}`}&deg;
                  </span>
                </div>
                {med_state === "Mild" ? (
                  <div className="patient-home-indication-box">
                    ...
                    <div className="text">
                      <em>Okay</em>
                      <p>
                        So far your records indicate you're in a mild condition.
                        <span>
                          {" "}
                          Please stay calm and follow your routine.
                        </span>{" "}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="patient-home-indication-box critical">
                    ...
                    <div className="text">
                      <em>Critical</em>
                      <p>
                        The state of things are getting too bad.
                        <span>
                          {" "}
                          The doctor advises you to use the emergency button.
                        </span>{" "}
                      </p>
                    </div>
                  </div>
