...
class AddPrescription extends Component {
  ...
  handlePrescriptionAdd = () => {
    ...
    const prescriptionInfo = {
      ...
      info: [
        [this.state.dosage, this.state.startDate, this.state.endDate],
        timegap,
      ],
    };
      ...
      <div className="add-prescription-page">
        ...
        {this.state.addPrescriptionError && (
          <p className="add-perscription_msg add-perscription_error">
            Sorry, we encountered an error while trying to submit the new
        ...
        <Link to="/Patient-details" className="btn save-btn">
          Save
        </Link>
      </div>
    );
